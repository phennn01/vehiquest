...
<head>
    ...
    <title>Admin Dashboard - Driver Trip Ticket</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .print-ticket .date-section {
            text-align: right;
            margin-bottom: 20px;
        }

        .print-ticket .section-title {
            font-weight: bold;
            margin-top: 20px;
            margin-bottom: 10px;
        }
        ...
        .print-ticket .signature-section {
            margin-top: 40px;
        }

        .print-ticket .signature-line {
...
<div class="header">
    ...
    <div class="nav-menu">
        <a href="admin_index.php" class="nav-btn active">Create Trip Ticket</a>
    ...
    <form id="tripTicketForm" method="POST" action="save_and_print_ticket.php">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="passenger_names" name="passenger_names" placeholder="e.g., John Doe, Jane Smith, Bob Johnson" rows="2"></textarea>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="text" id="place_visited" name="place_visited" required list="destinations-list" onchange="autoCalculateTrip()" onblur="calculateGPSDistance()">
